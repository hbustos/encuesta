...
class CorreoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Correo');
	...
	{
		$model=new Correo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Correo']))
			$model->attributes=$_GET['Correo'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Correo::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='correo-form')
		{
