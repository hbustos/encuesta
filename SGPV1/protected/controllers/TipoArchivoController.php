...
class TipoArchivoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoArchivo'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('TipoArchivo');
	...
	{
		$model=new TipoArchivo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TipoArchivo']))
			$model->attributes=$_GET['TipoArchivo'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=TipoArchivo::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-archivo-form')
		{
