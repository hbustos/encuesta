...
<div class="view">
	...
	<?php echo CHtml::encode($model->idBeneficiario->idInstitucion->Nombre); ?>
	<br />
        
	<b><?php echo CHtml::encode($model->getAttributeLabel('Banco')); ?>:</b>
	<?php echo CHtml::encode($model->idCuenta->idBanco->Banco); ?>
	<br />
