      		...
      		'items'=>array(
				...
				'items'=>array(
					...
					array('label'=>'Crear', 'url'=>array('/usuario/create')),
                     	...
                     	array('label'=>'Proyecto de Vida', 'url'=>array('/beneficiario/admin'),'visible'=>!Yii::app()->user->isGuest,
				'items'=>array(
					array('label'=>'Beneficiarios', 'url'=>array('/beneficiario/admin')),
					array('label'=>'Instituciones Educativas', 'url'=>array('/institucion/index')),
					array('label'=>'Programas', 'url'=>array('/programa/index')),
					array('label'=>'Regionales', 'url'=>array('/regional/index')),
					array('label'=>'Bancos', 'url'=>array('/banco/index')),
					array('label'=>'Cuentas', 'url'=>array('/cuenta/index')),
					array('label'=>'Referencias', 'url'=>array('/referencia/admin')),
                     			array('label'=>'Historial Académico', 'url'=>array('/historialAcademico/create')),
				),
			),
                      	array('label'=>'Pago', 'url'=>array('#'),'visible'=>!Yii::app()->user->isGuest,
				'items'=>array(
					array('label'=>'Conceptos de Pago','url'=>array('/conceptosDePago/admin')),
					array('label'=>'Ingresar Pago', 'url'=>array('/pagos/create')),
                                        array('label'=>'Generar Planilla Temporal','url'=>array('/pago/planillatemp')),
                     			array('label'=>'Generar Planilla de Pago','url'=>array('/pago/planillaPago')),
				),
			),
                      	array('label'=>'Archivos', 'url'=>array('#'),'visible'=>!Yii::app()->user->isGuest,
				'items'=>array(
					array('label'=>'Tipos de archivo','url'=>array('/tipoArchivo/admin')),
					array('label'=>'Subir Archivos','url'=>array('/archivo/create')),
				),
			),
